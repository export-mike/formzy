...
var GET_VALUES = {
  text: function text(field, e) {
    return e.target.value;
  },
  email: function email(field, e) {
    return e.target.value;
  },
  password: function password(field, e) {
    return e.target.value;
  },
  number: function number(field, e) {
    return parseInt(e.target.value, 10);
  },
  float: function float(field, e) {
    return parseFloat(e.target.value);
  },
  date: function date(field, e) {
    return new Date(e.target.value);
  },
  radio: function radio(field, e) {
    return field.value.map(function(option) {
      return Object.assign({}, option, {
        checked: option.id === e.id,
      });
    });
  },
  object: function object(field, e) {
    return e;
  },
  array: function array(field, e) {
    return field.value.map(function(option) {
      return Object.assign({}, option, {
...
var TO_DATA = {
  ...
  radio: function radio(field) {
    return field.value.find(function(option) {
  ...
  array: function array(field) {
    return field.value.filter(function(option) {
      return option.checked;
    });
  },
};
var toData = function toData(field) {
  return TO_DATA[field.type](field);
};

var getValue = function getValue(field, e) {
  return GET_VALUES[field.type](field, e);
};
...
var Formzy = (function(_PureComponent) {
  ...
  function Formzy(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Formzy.__proto__ || Object.getPrototypeOf(Formzy)).call(this, props)
    );
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.validate = function() {
    ...
    _this2.setState(
        ...
        fields: Object.keys(_this2.state.fields).reduce(function(acc, k) {
          ...
          return Object.assign(
            ...
            _defineProperty(
              {},
              k,
              Object.assign({}, _this2.state.fields[k], {
                error: errors[k],
              })
            )
          );
      ...
      function() {
        return _this2.props.onChange(_this2.stateToData());
      }
    );
  };
  ...
  this.consumerProps = function() {
    return {
      ...
      fetch: _this2.fetch,
      setValues: _this2.setValues,
    };
  };

  this.setValues = function(values) {
    var fields = _this2.state.fields;
    var updatedFields = Object.keys(fields).reduce(function(
      updatedFields,
      key
    ) {
      return Object.assign(
    ...
    return Object.keys(fields).reduce(function(acc, key) {
      ...
      return Object.assign(
        ...
        _defineProperty(
          ...
          key,
          Object.assign({}, rest, {
            onChange: _this2.onChange(field),
            onBlur: _this2.onBlur(field),
            onFocus: _this2.onFocus(field),
          })
        )
      );
    }, {});
  ...
  this.fetch = (function() {
    var _ref = _asyncToGenerator(
      /*#__PURE__*/ _regenerator2.default.mark(function _callee(fn) {
        var fields;
              ...
              switch ((_context.prev = _context.next)) {
                case 0:
                  ...
                  if (process.env.NODE_ENV !== 'production') {
                    console.error(
                      'Formzy: fetch prop requires an async/promise function'
                    );
                  }
  ...
  this.stateToData = function() {
    var data = Object.keys(_this2.state.fields).reduce(function(acc, k) {
      ...
      return Object.assign(
        {},
        acc,
        _defineProperty({}, k, toData(_this2.state.fields[k]))
      );
    }, {});
  ...
  this.submit = (function() {
    var _ref2 = _asyncToGenerator(
      /*#__PURE__*/ _regenerator2.default.mark(function _callee2(e) {
        var fields;
        return _regenerator2.default.wrap(
            ...
            while (1) {
              switch ((_context2.prev = _context2.next)) {
                case 0:
                  ...
                  if (process.env.NODE_ENV !== 'production') {
                    console.error(
                      'Formzy: submit prop requires an async/promise function'
                    );
                  }
