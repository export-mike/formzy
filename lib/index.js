...
var _initialiseProps = function _initialiseProps() {
  ...
  this.setValues = function (values) {
    ...
    var updatedFields = Object.keys(fields).reduce(function (updatedFields, key) {
      return Object.assign({}, updatedFields, _defineProperty({}, key, Object.assign({}, fields[key], {
  ...
  this.toConsumerFields = function (fields) {
    return Object.keys(fields).reduce(function (acc, key) {
      ...
      return Object.assign({}, acc, _defineProperty({}, key, Object.assign({}, rest, {
  ...
  this.stateToData = function () {
    var data = Object.keys(_this2.state.fields).reduce(function (acc, k) {
      if (!_this2.state.fields[k]) return acc;
      return Object.assign({}, acc, _defineProperty({}, k, toData(_this2.state.fields[k])));
    }, {});
