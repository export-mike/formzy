...
test('Form should render with initial values from fetch without loading state', function(
  cb
) {
  var initialValue = { make: 'rover', model: '200', mileage: 97000 };
  var tree = (0, _enzyme.mount)(
...
test('Form should render with submit correct render props and call submit callback', function() {
  ...
  var tree = (0, _enzyme.mount)(
    _react2.default.createElement(
      ...
      _defineProperty(_React$createElement, 'submit', submitSpy),
      _defineProperty(
        _React$createElement,
        'render',
        renderPropsSpy(function(_ref8) {
      ...
      _defineProperty(_React$createElement, '__self', undefined),
      _React$createElement)
    )
  );
  var input = tree.find('input[placeholder="Mileage (Miles)"]');
...
test('Form should render with initial values from fail fetch loading state', function(
  cb
) {
  var initialValue = { make: 'rover', model: '200', mileage: 97000 };
  var tree = (0, _enzyme.mount)(
